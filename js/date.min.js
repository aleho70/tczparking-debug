Date.fromString = (function () {
  ...
  var find_time = function (norm) {
    ...
    if (obj.time == obj.date) obj.time = norm.replace(/^.*-(\d\d?-(AM|PM))-.*$/, '$1');
  ...
  var find_day = function (norm, year, month) {
    // AHO 20120110 previous solution was not correctly working, alone month replacement was replaced by '-'+month+'-' to correctly solve e.g. 10.1.2012 8:30 which is -10-1-2013-
